//  Приклад зчитування поточного часу:                     //
                                                            //
#include <iarduino_RTC.h>                                   // Підключаємо бібліотеку iarduino_RTC для роботи з модулями реального часу.

iarduino_RTC watch(RTC_DS1307);                         // Оновлюємо обʼєкт watch для работи з RTC модулем на базі чипу DS1307, використовується шина I2C.
...
void setup(){
    ...
    watch.begin();                                          // Ініціюємо роботу з модулем.
}
void loop(){
